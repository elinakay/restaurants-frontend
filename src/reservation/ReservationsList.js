...
/**
 * Displays a list of reservations with options to seat, edit, and cancel reservations.
 *
 * @param {Array} reservations - List of reservations to display.
 * @param {Function} cancelHandler - Callback function to handle reservation cancellation.
 * @param {boolean} filterResults - Indicates whether to filter out finished or cancelled reservations.
 * @returns {JSX.Element} - A list of reservations.
 */
export const ReservationsList = ({ reservations, cancelHandler, filterResults }) => {
